import blueyellow_pycharm_app.infrastructure.static_cache as static_cache
...
class BaseController:
    def __init__(self, request):
        ...
        layout_render = pyramid.renderers.get_renderer('blueyellow_pycharm_app:templates/shared/_layout.pt')
